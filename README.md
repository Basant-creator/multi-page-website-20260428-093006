...
This is a **multi-page static website** — a collection of HTML pages linked together with a navigation menu. Like the landing page version, no server is needed. Each page is its own HTML file that the browser loads when you click a link.

### How it works

The CSS file(s) control the shared look across all pages. The JavaScript file(s) handle the navigation menu (including the mobile hamburger menu) and any animations or interactive sections.
...
| File | What it does |
|------|-------------|
| `about.html**` | A supporting project file. |
| `contact.html**` | A supporting project file. |
| `css/responsive.css**` | A supporting project file. |
| `css/style.css**` | A supporting project file. |
| `index.html**` | A supporting project file. |
| `js/navigation.js**` | A supporting project file. |
| `js/script.js**` | A supporting project file. |
| `services.html**` | A supporting project file. |
